...
class NetflixTitle:
    ...
    def __init__(self, title, content_type, country, release_year):
        self.title = title
    ...
    def load_data(self, filename):
        ...
        try:
            with open(filename, "r", encoding="utf-8") as file:
                ...
                for row in reader:
                    obj = NetflixTitle(row["title"], row["type"], row["country"], row["release_year"])
...
dashboard = NetflixAnalyzer("netflix_titles.csv")
